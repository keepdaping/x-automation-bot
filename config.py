...
class Config:
    ...
    SESSION_EXTENDED_BREAK_PROBABILITY = float(os.getenv("SESSION_EXTENDED_BREAK_PROBABILITY", "0.20"))
    ...
    SESSION_BROWSE_ONLY_PROBABILITY = float(os.getenv("SESSION_BROWSE_ONLY_PROBABILITY", "0.10"))
