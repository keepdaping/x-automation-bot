...
"""Generate → critique → rewrite → final tweet"""
...
* things beginners misunderstand
  ...
  ```
        ...
        if not draft or len(draft) > 280:
            log.warning("Draft length invalid — retrying")
            continue
...
You are a brutally honest X growth consultant.
...
```
        ...
        # lowered threshold for real-world virality
...
Rewrite this tweet to make it more viral.
...
* engagement potential
  ...
  "Freelancing is uncomfortable. So is being broke. Pick one.",
  ]
...
"""
Generate a natural contextual reply to a tweet.
"""
...
You are replying to a tweet on X.

Tweet:
{tweet_text}

Write a short human reply.

Rules:

* sound natural
* conversational tone
* add a thought or perspective
* max 2 sentences
* no hashtags
* no emojis
  """
